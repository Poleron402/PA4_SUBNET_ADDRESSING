...
def myNetwork():
    ...
    net.addLink(r4, r5, intfName1='r4-eth1',params1={'ip':'192.168.1.4/30'}, intfName2='r5-eth1', params2={'ip':'192.168.1.3/30'})

    info( '*** Starting network\n')
    net.build()
    net['r3'].cmd('ip route add 10.0.2.0/24 via 192.168.1.3 dev r3-eth1')
    net['r3'].cmd('ip route add 192.168.1.0/30 via 192.168.1.4 dev dev r3-eth1')
    net['r4'].cmd('ip route add 10.0.1.0/24 via 192.168.0.3 dev r4-eth0')
    net['r4'].cmd('ip route add 10.0.2.0/24 via 192.168.1.3 dev r4-eth1')
    net['r5'].cmd('ip route add 10.0.1.0/24 via 192.168.1.4 dev r5-eth1')
    net['r5'].cmd('ip route add 192.168.0.0/30 via 192.168.1.4 dev r5-eth1')
